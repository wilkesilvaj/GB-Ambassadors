...
<html lang = "en">
  <head>
    ...
    <body>
        ...
        <!-- MODAL FOR APPLICATIONS' DEADLINE -->
        <div id = "myModal" class="modal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div id = "ambassadors-modal" class="modal-content">
                    <div class="modal-header bg-gb-conference">
                        <h3 class = "ambassador">ATTENTION APPLICANTS</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>                        
                    </div>   
                    <div class = "modal-body">
                        <h4>Thank you for taking an interest in becoming a Gracie Barra Ambassador!</h4>
                        <h4> We are thrilled that you would like to represent the GB family, but we would just like
                            to tell you that applications will be reviewed <span class = "ambassador"><u>between April 1st and April 20th.</u></spam></h4>
                    </div>                           
                </div>
            </div>
        </div>
